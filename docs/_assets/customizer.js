...
MaterialCustomizer = ( function() {
    ...
    MaterialCustomizer.prototype.buildWheel_ = function() {
        ...
        config.colors.forEach(function(color, idx) {
            ...
            field.id = color;
            field.querySelector('.polygons > *:nth-child(1)').style.fill = 'rgb(' + this.getColor(color, '500') + ')';
            field.querySelector('.polygons > *:nth-child(2)').style.fill = 'rgb(' + this.getColor(color, '700') + ')';
            field.querySelector('.polygons').addEventListener('click', this.fieldClicked_.bind(this));
    ...
    MaterialCustomizer.prototype.fieldClicked_ = function(ev) {
        ...
        case 2:
            Array.prototype.forEach.call(
                this.wheel.querySelector('g.wheel--maing').childNodes, function(f) {
    ...
    MaterialCustomizer.prototype.calculateContrast = function(background, foreground) {
